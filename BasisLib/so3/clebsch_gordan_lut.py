...
from .symbolic import _clebsch_gordan
...
def generate_clebsch_gordan_lookup_table(
    ...
    for (l1, m1, l2, m2, l3, m3), cg in zip(degrees_and_orders, cg_coefficients):
        lookup_table["cg"][l1 * l1 + l1 + m1, l2 * l2 + l2 + m2, l3 * l3 + l3 + m3] = cg
...
if __name__ == "__main__":
    ...
    generate_clebsch_gordan_lookup_table(
